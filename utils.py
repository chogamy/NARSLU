...
from model import JointBERT, JointDistilBERT, JointAlbert, NARBERT, NARBERTX

MODEL_CLASSES = {
    "bert": (BertConfig, JointBERT, BertTokenizer),
    "distilbert": (DistilBertConfig, JointDistilBERT, DistilBertTokenizer),
    "albert": (AlbertConfig, JointAlbert, AlbertTokenizer),
    "nar": (BertConfig, NARBERT, BertTokenizer),
    "nar_x": (BertConfig, NARBERTX, BertTokenizer),
}
...
MODEL_PATH_MAP = {
    ...
    "nar": "bert-base-uncased",
    "nar_x": "bert-base-uncased",
}
...
def get_intent_labels(args):
    return [
        label.strip()
        for label in open(
            os.path.join(args.data_dir, args.task, args.intent_label_file),
            "r",
            encoding="utf-8",
        )
    ]
